...
- **The Nasty install (17 plays, zero new words)**: Nasty Rt Lion / Nasty Lt Rhino (weak-side power, wing kicks), Rabbit/Lynx, Renegade/Lizard, Nasty Rt Owl / Nasty Lt Owl, Nasty Rt Lion Owl, Nasty Lt Laser Owl, Nasty Rt Laffy / Nasty Lt Reese's (smokes to the wide X), Nasty Rt Rhino Now / Nasty Lt Lion Now, Nasty Rt/Lt Eagle, Nasty Rt Rewind. Dry-run against the live blob: 71 -> 88 plays, numbers 79-95, nothing existing touched.
...
- **Game plans**: GAME_PLANS + applyGamePlan(); "Load game plan..." on the Call Sheet tab replaces the sheet, the keys, the game label, and points the wristband at exactly those plays. First plan: Thompson (4-4), Tue Sept 8. Week of Sept 1 context: the starting Speed H sprained an ankle, so the plan lives in Heavy and Super Heavy (run first, smokes, the post) and keeps Speed for 3rd and long.
